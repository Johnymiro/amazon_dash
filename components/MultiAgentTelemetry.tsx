            ...
            <section className="bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl p-4">
                <div className="animate-pulse space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="h-32 bg-gray-50 dark:bg-white/[0.03] rounded"></div>
                        ))}
                    </div>
                </div>
            </section>
        ...
        <section className="bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
            ...
            <div className="bg-gray-100 dark:bg-[#0d0d0d] border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-mono text-gray-700 dark:text-gray-300">MULTI-AGENT DECISION TRACE</span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 dark:divide-gray-800">
                ...
                {/* === STRATEGIST (The Head) === */}
                <div
                    className={`p-4 cursor-pointer transition-colors ${expandedSection === 'strategist' ? 'bg-white dark:bg-white/[0.02]' : 'hover:bg-gray-100 dark:hover:bg-gray-800/20'}`}
                    onClick={() => setExpandedSection(expandedSection === 'strategist' ? null : 'strategist')}
                >
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            <span className="text-lg">🎯</span>
                            <span className="text-sm font-bold text-gray-800 dark:text-gray-200">STRATEGIST</span>
                        </div>
                        <span className="text-xs text-gray-400 dark:text-gray-500">The Head</span>
                    </div>

                    {/* Current Mission Header */}
                    <div className="mb-3">
                        <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1">Current Mission</div>
                    ...
                    {/* Objective Function */}
                    <div className="mb-3">
                        <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1">Objective Function</div>
                    ...
                    <div className="mb-3">
                        <div className="flex items-center gap-2 mb-1">
                            <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500">Stability Meter</div>
                            <div className="group relative">
                                <span className="text-[10px] text-gray-400 dark:text-gray-500 cursor-help">ⓘ</span>
                                <div className="absolute bottom-full left-0 mb-1 hidden group-hover:block bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded px-2 py-1 text-[9px] text-gray-700 dark:text-gray-300 whitespace-nowrap z-10">
                        ...
                        <div className="flex justify-between items-center mt-1">
                            <span className={`text-xs font-mono ${telemetry.strategist.is_stable ? 'text-success-400' : 'text-warning-400'
                                }`}>
                    ...
                    {expandedSection === 'strategist' && (
                        <div className="mt-4 pt-3 border-t border-gray-300 dark:border-gray-700 space-y-2">
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="text-gray-700 dark:text-gray-300">{(telemetry.strategist.confidence * 100).toFixed(0)}%</span>
                            </div>
                            {telemetry.strategist.last_transition && (
                                <div className="flex justify-between text-xs">
                                    <span className="text-gray-400 dark:text-gray-500">Last Transition</span>
                                    <span className="text-gray-700 dark:text-gray-300">{telemetry.strategist.last_transition}</span>
                                </div>
                            )}
                            <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-800">
                                <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-2">Delegation Orders</div>
                                {Object.entries(telemetry.strategist.delegation_orders).map(([agent, order]) => (
                                    <div key={agent} className="flex gap-2 text-xs mb-1">
                                        <span className="text-gray-500 dark:text-gray-400 capitalize">{agent}:</span>
                                        <span className="text-gray-700 dark:text-gray-300">{order}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {/* === SENTINEL (The Brake) === */}
                <div
                    className={`p-4 cursor-pointer transition-colors ${expandedSection === 'sentinel' ? 'bg-white dark:bg-white/[0.02]' : 'hover:bg-gray-100 dark:hover:bg-gray-800/20'}`}
                    onClick={() => setExpandedSection(expandedSection === 'sentinel' ? null : 'sentinel')}
                >
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            <span className="text-lg">🛡️</span>
                            <span className="text-sm font-bold text-gray-800 dark:text-gray-200">SENTINEL</span>
                        </div>
                        <span className="text-xs text-gray-400 dark:text-gray-500">The Brake</span>
                    </div>

                    {/* Supply Pulse Indicator */}
                    <div className="mb-3">
                        <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1">Supply Pulse</div>
                    ...
                    {telemetry.sentinel.is_braking && (
                        <div className="mb-3 p-2 bg-error-500/5 border border-red-800/50 rounded text-xs text-error-300">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500">L<sub>eff</sub></div>
                            <div className="text-xl font-bold text-gray-800 dark:text-gray-200 font-mono">
                                {telemetry.sentinel.l_eff}d
                            </div>
                        </div>
                        <div>
                            <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500">M<sub>supply</sub></div>
                            <div className={`text-xl font-bold font-mono ${telemetry.sentinel.m_supply >= 0.9 ? 'text-success-400' :
                                telemetry.sentinel.m_supply >= 0.5 ? 'text-warning-400' : 'text-error-400'
                                }`}>
                    ...
                    {expandedSection === 'sentinel' && (
                        <div className="mt-4 pt-3 border-t border-gray-300 dark:border-gray-700 space-y-2">
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400 dark:text-gray-500">Days of Supply (DoS)</span>
                                <span className="text-gray-700 dark:text-gray-300">{telemetry.sentinel.dos.toFixed(1)} days</span>
                            </div>
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400 dark:text-gray-500">Current Stock</span>
                                <span className="text-gray-700 dark:text-gray-300">{telemetry.sentinel.current_stock?.toLocaleString() || '--'} units</span>
                            </div>
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400 dark:text-gray-500">Inbound</span>
                                <span className="text-gray-700 dark:text-gray-300">{telemetry.sentinel.inbound_stock?.toLocaleString() || '--'} units</span>
                            </div>
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400 dark:text-gray-500">Status</span>
                                <span className="text-gray-700 dark:text-gray-300">{telemetry.sentinel.status}</span>
                            </div>
                            <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-800">
                                <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-2">Sigmoid Formula</div>
                                <div className="text-xs font-mono text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-white/[0.03] p-2 rounded">
                                    M = 1 / (1 + e^(-k(DoS - L_eff)))
                                </div>
                            </div>
                        </div>
                ...
                {/* === SEMANTIC (The Eye) === */}
                <div
                    className={`p-4 cursor-pointer transition-colors ${expandedSection === 'semantic' ? 'bg-white dark:bg-white/[0.02]' : 'hover:bg-gray-100 dark:hover:bg-gray-800/20'}`}
                    onClick={() => setExpandedSection(expandedSection === 'semantic' ? null : 'semantic')}
                >
                    <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                            <span className="text-lg">👁️</span>
                            <span className="text-sm font-bold text-gray-800 dark:text-gray-200">SEMANTIC</span>
                        </div>
                        <span className="text-xs text-gray-400 dark:text-gray-500">The Eye</span>
                    </div>

                    {/* Discovery Counter */}
                    <div className="mb-3">
                        <div className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-1">Semantic Discovery</div>
                        <div className="flex items-center gap-3">
                    ...
                    {telemetry.semantic.discoveries.length > 0 && (
                        <div className="p-2 bg-brand-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800/30 rounded">
                            <div className="text-xs text-brand-300 font-mono truncate">
                    ...
                    {expandedSection === 'semantic' && (
                        <div className="mt-4 pt-3 border-t border-gray-300 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-2 mb-3 text-[10px] text-gray-400 dark:text-gray-500">
                            ...
                            <div className="space-y-2 max-h-48 overflow-y-auto">
                                {telemetry.semantic.discoveries.map((discovery, idx) => {
                                    ...
                                    const statusStyles: Record<string, { bg: string; text: string; label: string }> = {
                                        'PENDING_HARVEST': { bg: 'bg-warning-500/20', text: 'text-warning-400', label: '⏳ PENDING' },
                                        'AUTO_HARVESTED': { bg: 'bg-success-500/10', text: 'text-success-400', label: '✓ HARVESTED' },
                                        'MANUAL_HARVESTED': { bg: 'bg-brand-500/10', text: 'text-blue-light-400', label: '👤 MANUAL' },
                                        'REVIEW_REQUIRED': { bg: 'bg-warning-500/10', text: 'text-warning-400', label: '? REVIEW' },
                                    ...
                                    return (
                                        <div key={idx} className="flex items-start gap-2 text-xs p-2 bg-gray-50 dark:bg-white/[0.02] rounded">
                                            <span className={`mt-0.5 ${discovery.action === 'promoted' ? 'text-success-400' :
                                                discovery.action === 'flagged' ? 'text-warning-400' : 'text-error-400'
                                                }`}>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center justify-between gap-2">
                                                    <span className="font-mono text-gray-700 dark:text-gray-300 truncate">"{discovery.term}"</span>
                                                ...
                                                <div className="text-gray-500 dark:text-gray-400 text-[10px]">{discovery.reason}</div>
                                            </div>
                                        </div>
                                    );
                                })}
                            ...
                            {/* Pipeline Summary */}
                            <div className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-800 flex justify-between text-[10px]">
